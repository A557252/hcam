 ...
 * 
 * @Import(SwaggerConfig.class) public class DevChallengeApplication {
 * 
 ...
 * ThreadPoolTaskExecutor(); executor.setCorePoolSize(4);
 * executor.setMaxPoolSize(5); executor.setQueueCapacity(500);
 * executor.setThreadNamePrefix("EmailNotification-"); executor.initialize();
 * return executor; } }
 */
