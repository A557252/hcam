...
import com.db.hcam.repository.AccountsRepositoryInMemory;
import com.db.hcam.service.AccountsService;
import com.db.hcam.service.EmailNotificationService;
...
public class AccountServiceParallelConcurrentTest {
	...
	public void whenNegativeAmountTransferthenThrowsInvalidAmmountException()
		...
		} catch (InvalidAmmountException | com.db.hcam.exception.LockException e) {
	...
	public void whenAmountTransferWithNullFromAccountthenThrowsInvalidAccountException()
		...
		} catch (InvalidAccountException | com.db.hcam.exception.LockException e) {
			assertThat(e.getMessage()).isEqualTo(
	...
	public void whenTransferAmountIsGreaterThenAccountBalanceThenThrowsInsufficientFundsException()
		...
		} catch (InsufficientFundsException | com.db.hcam.exception.LockException e) {
